...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Добавить новую покупку</title>
    ...
    <div id="add_new_supplier_model">
      <div class="modal-dialog">
      	<div class="modal-content">
            ...
            <div class="font-weight-bold">Добавить нового поставщика</div>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('bar-chart', 'Добавить покупки', 'Добавить новые покупки');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-4 form-group">
              <label class="font-weight-bold" for="suppliers_name">Поставщик:</label>
              <input id="suppliers_name" type="text" class="form-control" placeholder="Имя поставщика" name="suppliers_name" onkeyup="showSuggestions(this.value, 'supplier');">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="">Номер счет-фактуры :</label>
              <input type="number" class="form-control" placeholder="Номер счет-фактуры" id="invoice_number" name="invoice_number" onblur="notNull(this.value, 'invoice_number_error'); checkInvoice(this.value, 'invoice_number_error');">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="paytype">Метод оплаты :</label>
              <select id="payment_type" name="paytype" class="form-control">
              	<option value="Cash Payment">Оплата наличными</option>
                <option value="Net Banking">Интернет-банкинг</option>
                <option value="Payment Due">Платеж Due</option>
              </select>
            </div>

            <div class="col col-md-2 form-group">
               <label class="font-weight-bold" for="invoice_date">Дата :</label>
          ...
          <div class="row col col-md-12">
            <div class="col col-md-2 font-weight-bold" style="color: green; cursor:pointer" onclick="document.getElementById('add_new_supplier_model').style.display = 'block';">
            	<i class="fa fa-plus"></i>&nbsp;Добавить нового поставщика
            </div>
          </div>
          ...
          <div class="row col col-md-12 font-weight-bold">
            ...
            <div class="col col-md-1">Упаковка</div>
            <div class="col col-md-2">ID партии</div>
            <div class="col col-md-1">Дата истечения(mm/yy)</div>
            <div class="col col-md-1">Количество</div>
            <div class="col col-md-1">MRP</div>
            <div class="col col-md-1">Оценка</div>
            <div class="row col col-md-3">
              <div class="col col-md-7">Сумма</div>
              <div class="col col-md-5">Действие</div>
            </div>
          </div>
          <div class="col col-md-12">
            <hr class="col-md-12" style="padding: 0px; border-top: 2px solid  #02b6ff;">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary form-control" onclick="addPurchase();">Добавить</button>
            </div>
            <div class="col col-md-5"></div>
          </div>
          <!-- closing button -->
