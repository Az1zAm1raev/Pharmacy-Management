    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('home', 'Главная', 'Домой');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_customer.php', 'Все клиенты', 'customers');
              createSection1('manage_supplier.php', 'Все поставщики', 'suppliers');
              createSection1('manage_medicine.php', 'Все лекарства', 'medicines');
              createSection1('manage_medicine_stock.php?out_of_stock', 'Нет в наличии', 'medicines_stock');
              createSection1('manage_medicine_stock.php?expired', 'Просроченный', 'medicines_stock');
              createSection1('manage_invoice.php', 'Все счет фактуры', 'invoices');
            ?>
          ...
          <div class="col col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding: 7px 0; margin-left: 15px;">
            <div class="todays-report">
              <div class="h5">Сегодняшний отчет</div>
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('address-card', 'new_invoice.php', 'Создать новый счет-фактуру');
            createSection2('handshake', 'add_customer.php', 'Добавить нового клиента');
            createSection2('shopping-bag', 'add_medicine.php', 'Добавить новые лекарства');
            createSection2('group', 'add_supplier.php', 'Добавить нового поставщика');
            createSection2('bar-chart', 'add_purchase.php', 'Добавить новую покупку');
            createSection2('book', 'sales_report.php', 'Отчет по продажам');
            createSection2('book', 'purchase_report.php', 'Отчет о закупках');
          ?>
