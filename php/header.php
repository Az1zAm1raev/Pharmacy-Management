    ...
    <section class="row content-header">
      ...
      <div class="col-md-1 user_options">
        ...
        <ul id="options" class="options list-unstyled" style="display: none;">
          <li>
            <a href="my_profile.php"><i class="fa fa-user"></i><span>Мой профиль</span></a>
          </li>
          <li>
            <a href="change_password.php"><i class="fa fa-edit"></i><span>Изменить пароль</span></a>
          </li>
          <li>
            <a href="logout.php"><i class="fa fa-key"></i><span>Выйти</span></a>
          </li>
        </ul>
      </div>
    </section>
