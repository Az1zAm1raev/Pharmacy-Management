    ...
    <div id="add_new_customer_model">
      <div class="modal-dialog">
      	<div class="modal-content">
            ...
            <div class="font-weight-bold">Добавить нового клиента</div>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('clipboard', 'Новая счет-фактура', 'Создать новую счет-фактуру');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            <div class="col col-md-3 form-group">
              <label class="font-weight-bold" for="customers_name">Имя клиента :</label>
              <input id="customers_name" type="text" class="form-control" placeholder="Имя Клиента" name="customers_name" onkeyup="showSuggestions(this.value, 'customer');">
            ...
            <div class="col col-md-3 form-group">
              <label class="font-weight-bold" for="customers_address">Адрес :</label>
              <input id="customers_address" type="text" class="form-control" name="customers_address" placeholder="Адрес" disabled>
            </div>
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="invoice_number">Номер счет-фактуры :</label>
              <input id="invoice_number" type="text" class="form-control" name="invoice_number" placeholder="Номер счет-фактуры" disabled>
            </div>
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="">Метод оплаты :</label>
              <select id="payment_type" class="form-control">
              	<option value="1">Оплата наличными</option>
              	<option value="2">Оплата картой</option>
                <option value="3">Безналичный рассчет</option>
              </select>
            </div>
            <div class="col col-md-2 form-group">
               <label class="font-weight-bold" for="">Дата :</label>
          ...
          <div class="row col col-md-12">
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary form-control" onclick="document.getElementById('add_new_customer_model').style.display = 'block';">Новый Клиент</button>
            </div>
            <div class="col col-md-1 form-group"></div>
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="customers_contact_number">Контактный номер :</label>
              <input id="customers_contact_number" type="number" class="form-control" name="customers_contact_number" placeholder="Контактный номер" disabled>
            </div>
          </div>
          ...
          <div class="row col col-md-12">
            <div class="row col col-md-12 font-weight-bold">
              <div class="col col-md-2">Название лекарства</div>
              <div class="col col-md-2">Серийный ID</div>
              <div class="col col-md-1">Дост. Кол-во.</div>
              <div class="col col-md-1">Срок истечения</div>
              <div class="col col-md-1">Кол-во</div>
              <div class="col col-md-1">MRP</div>
              <div class="col col-md-1">Скидка(%)</div>
              <div class="col col-md-1">Итого</div>
              <div class="col col-md-2">Действие</div>
            </div>
          </div>
          <div class="col col-md-12">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Общая сумма :</label>
              <input type="text" class="form-control" value="0" id="total_amount" disabled>
            </div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Общая скидка :</label>
              <input type="text" class="form-control" value="0" id="total_discount" disabled>
            </div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Общая итоговая :</label>
          ...
          <div class="row col col-md-12">
            <div id="save_button" class="col col-md-2 form-group float-right">
              ...
              <button class="btn btn-success form-control font-weight-bold" onclick="addInvoice();">Сохранить</button>
            </div>
            <div id="new_invoice_button" class="col col-md-2 form-group float-right"  style="display: none;">
              <label class="font-weight-bold" for=""></label>
              <button class="btn btn-primary form-control font-weight-bold" onclick="location.reload();;">Новая счет-фактура</button>
            </div>
            <div id="print_button" class="col col-md-2 form-group float-right" style="display: none;">
              <label class="font-weight-bold" for=""></label>
              <button class="btn btn-warning form-control font-weight-bold" onclick="printInvoice(document.getElementById('invoice_number').value);">Печать</button>
            </div>
            <div class="col col-md-4 form-group"></div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Оплаченной суммы :</label>
              <input type="text" class="form-control" name="total_discount" onkeyup="getChange(this.value);">
            </div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Изменть :</label>
